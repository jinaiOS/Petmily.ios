...
class MyPageProfileView: UIView {
    ...
    var settingButton: UIButton = {
        ...
        let scaledImage = image?.scalePreservingAspectRatio(targetSize: CGSize(width: Constants.Size.size30, height: Constants.Size.size30))
    ...
    var editProfileButton: UIButton = {
        ...
        btn.titleLabel?.font = ThemeFont.b10
        ...
        btn.cornerRadius = Constants.Radius.radius9
        return btn
    }()
    ...
    var profileImage: UIImageView = {
        ...
        view.bounds.size.width = Constants.Size.size52
        view.bounds.size.height = Constants.Size.size52
